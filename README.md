...
Plugins extend the agent runtime with new endpoints, integrations, and background services. See the full plugin registry and manifest standard in **[PLUGINS.md](PLUGINS.md)**.
